...
import GoogleIMAPlayer from "@/components/ads/GoogleIMAPlayer";
// import VideoPlayerWithAds, { Ad } from "@/components/ads/VideoPlayerWithAds";
  ...
  return (
    <main className="fixed inset-0 bg-black flex flex-col">
      ...
      <div className="flex-1 w-full h-full relative bg-black flex flex-col items-center justify-center">
        ...
        <div className="relative w-full h-full flex items-center justify-center">
          {currentEpisodeData ? (
            <GoogleIMAPlayer
              ...
              adTagUrl={adConfig?.prerollVastUrl} // In real app, choose based on state (preroll/midroll) or use VMAP
        ...
        {/* Hide controls when ad is playing? VideoPlayerWithAds handles its own UI, but these are external controls */}
        {/* We might want to hide these if an ad is playing, but the state is inside the component. */}
        {/* For now, we keep them but maybe disable them or they just sit on top. */}
